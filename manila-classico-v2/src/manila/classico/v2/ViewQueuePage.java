...
public class ViewQueuePage extends javax.swing.JFrame {
    ...
    private void refreshQueueDisplay() {
        ...
        // Current is the first of the already-sorted list in ReservationsData
        ...
        // OPTIONAL: If you add a "Serve Next" button in GUI, call this in its actionPerformed
    private void serveNext() {
        if (ReservationsData.removeFirstReservation()) {
            refreshQueueDisplay();
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "No reservations to serve.");
        }
    }
