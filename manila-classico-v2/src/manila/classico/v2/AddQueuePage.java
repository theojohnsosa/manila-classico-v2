...
public class AddQueuePage extends javax.swing.JFrame {
    ...
    private static final Logger logger = Logger.getLogger(AddQueuePage.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel7.setText("<html><div style=\"text-align: center;\">Add to Queue</div></html>");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AddQueuePage().setVisible(true));
    }
